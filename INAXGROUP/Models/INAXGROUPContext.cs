...
using INAXGROUP.Models.Mapping;

namespace INAXGROUP.Models
{
    public partial class INAXGROUPContext : DbContext
    {
        static INAXGROUPContext()
        {
            Database.SetInitializer<INAXGROUPContext>(null);
        }

        public INAXGROUPContext()
            : base("Name=INAXGROUPContext")
        {
        }
